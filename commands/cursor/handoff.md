<!-- GENERATED from commands/handoff.md by render-commands.sh — do not edit. -->
# Handoff

Developer handoff for a screen/route — states, tokens, a11y, and acceptance criteria

> Cursor has no argument placeholder — type your input after `/handoff` and it is appended to this prompt; treat any `$ARGUMENTS` below as that input.
