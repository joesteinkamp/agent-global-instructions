...
Product-grade evaluation of recent work — prove it runs, then grade how well it serves this session's goal, briefs held as reference (and flag docs the code has outgrown)
...
Recent commits: run `git --no-pager log --oneline -10 2>/dev/null`
